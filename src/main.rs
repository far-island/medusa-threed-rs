use medusa_threed_rs::mesh_service::MeshServiceImpl;
use medusa_threed_rs::proto::farisland::threed::v1::mesh_service_server::MeshServiceServer;
use medusa_threed_rs::proto::farisland::threed::v1::point_cloud_service_server::PointCloudServiceServer;
use medusa_threed_rs::proto::farisland::threed::v1::scale_configuration_service_server::ScaleConfigurationServiceServer;
use medusa_threed_rs::proto::farisland::threed::v1::three_d_scan_service_server::ThreeDScanServiceServer;
use medusa_threed_rs::scale_configuration_service::ScaleConfigurationServiceImpl;
use medusa_threed_rs::scan_service::ThreeDScanServiceImpl;
use medusa_threed_rs::service::PointCloudServiceImpl;
use std::io::Write;
